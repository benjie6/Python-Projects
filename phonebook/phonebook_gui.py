...
def load_gui(self):
    ...
    self.lbl_lname = tk.Label(self.master,text='Lirst Name:')
    ...
    self.btn_close = tk.Button(self.master,width=12,height=2,text='Close',command=lambda: phonebook_func.asl_quit(self))
